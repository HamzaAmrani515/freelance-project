...
import { FreelancerRecommendationDTO, Mission, MissionControllerService, RecommendationControllerService } from '../../api';
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                Les freelances recommandés pour la mission: {titre}             
                       </div>
