...
COMPETENCE_ID_MIN = 97
COMPETENCE_ID_MAX = 500

# Fonction pour générer un client_id valide
def generate_valid_client_id():
    range1 = list(range(11, 61))  # IDs de 11 à 60
    range2 = list(range(81, 91))  # IDs de 81 à 90
    return random.choice(range1 + range2)  # Choisir un ID valide
